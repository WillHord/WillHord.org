...
import ProjectBox from "../../components/LargeProjectBox/ProjectBox_Hooks";
...
const Projects = (props) => {
    ...
    useEffect(() => {
        ...
        const getData = async () =>{
            Promise.all([
                ...
                await ComponentAPI.get('/Components/LargeProjectBoxViewSet/?expand=~all'),
            ]).then(res => {
    ...
    return(
        ...
        <TopMenu
          ...
          burgerColor={"white"}
        />
        <div className="ProjectTopImg" style={{backgroundImage: HeaderImageLoaded ? 'url(' + headerImage + ')' : 'none'}}/>

<script lang="ts">
  ...
  const onBeforeCompile = (shader: Shader, renderer: WebGLRenderer) => {
    ...
    shader.fragmentShader =
      "uniform float elapsedTime;" + shader.fragmentShader;
    shader.vertexShader = "uniform float spawnRadius;" + shader.vertexShader;
    shader.fragmentShader =
      "uniform float spawnRadius;" + shader.fragmentShader;
    ...
    shader.vertexShader =
      "varying float distanceToCenter;" + shader.vertexShader;
    shader.fragmentShader =
      "varying float distanceToCenter;" + shader.fragmentShader;

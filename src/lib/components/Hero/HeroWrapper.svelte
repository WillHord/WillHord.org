            ...
            <div class="col-span-1">
              ...
              >
                <FadeOut
                  ...
                  to={outEnd}
                >
                  <h3 class="mb-2 text-2xl font-bold text-white/90">
                    Learn Threlte
                  </h3>
                  <p class="text-sm text-white/60">
                    Threlte puts the simplicity of Svelte 5 and the power of
                    Three.js right at your fingertips. It's designed to be
                    powerful and flexible while still being approachable and
                    easy to use.
                  </p>
                </FadeOut>
              </Reveal>
            ...
            <div class="col-span-1">
              ...
              >
                ...
                >
                  ...
                  <p class="text-sm text-white/60">
                    The web is becoming more and more 3D. At its core, Threlte
                    provides an extendable declarative API for creating scalable
                    Three.js applications for the web.
                  </p>
                </FadeOut>
              </Reveal>
            </div>
            ...
            <div class="col-span-1">
              ...
              >
                ...
                >
                  ...
                  <p class="text-sm text-white/60">
                    Threlte comes with solutions for physics, XR, animation,
                    layouting, model loading, and countless helpers to make
                    creating immersive 3D apps for the web a breeze.
                  </p>
                </FadeOut>
              </Reveal>
            </div>

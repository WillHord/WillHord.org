...
const compareByLanguagePython = (a, b) => {
  if (
    a.props.programmingLanguages.includes("python") &&
    b.props.programmingLanguages.includes("python")
  ) {
    if (a.title > b.title) {
      return -1;
    } else {
...
const compareByLanguageSql = (a, b) => {
  if (
    a.props.programmingLanguages.includes("sql") &&
    b.props.programmingLanguages.includes("python")
  ) {
    if (a.title > b.title) {
      return -1;
...
const compareByLanguageJava = (a, b) => {
  if (
    a.props.programmingLanguages.includes("Java") &&
    b.props.programmingLanguages.includes("Java")
  ) {
    if (a.title > b.title) {
      return -1;
    } else {
...
const compareByLanguageCpp = (a, b) => {
  if (
    a.props.programmingLanguages.includes("C++") &&
    b.props.programmingLanguages.includes("C++")
  ) {
    if (a.title > b.title) {
      return -1;
    } else {
...
const compareByLanguageHTML = (a, b) => {
  if (
    a.props.programmingLanguages.includes("HTML") &&
    b.props.programmingLanguages.includes("HTML")
  ) {
    if (a.title > b.title) {
      return -1;
    } else {
...
const compareByLanguageCSS = (a, b) => {
  if (
    a.props.programmingLanguages.includes("CSS") &&
    b.props.programmingLanguages.includes("CSS")
  ) {
    if (a.title > b.title) {
      return -1;
    } else {
...
const compareByLanguageJavaScript = (a, b) => {
  if (
    a.props.programmingLanguages.includes("JavaScript") &&
    b.props.programmingLanguages.includes("JavaScript")
  ) {
    if (a.title > b.title) {
      return -1;
    } else {
...
const compareByLanguageReactJS = (a, b) => {
  if (
    a.props.programmingLanguages.includes("React Js") &&
    b.props.programmingLanguages.includes("React JS")
  ) {
    if (a.title > b.title) {
      return -1;
    } else {
...
const compareByLanguageR = (a, b) => {
  if (
    a.props.programmingLanguages.includes("R") &&
    b.props.programmingLanguages.includes("R")
  ) {
    if (a.title > b.title) {
      return -1;
    } else {
...
const compareByLanguagePHP = (a, b) => {
  if (
    a.props.programmingLanguages.includes("PHP") &&
    b.props.programmingLanguages.includes("PHP")
  ) {
    if (a.title > b.title) {
      return -1;
    } else {

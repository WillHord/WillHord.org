export const resumeData = {
  workExperience: [
    {
      index: 1,
      title: "University of California Santa Cruz - School of Engineering IT Department",
      ...
      image: {
        ...
        image: {
          full_size:
            "/imgs/resumeImages/UCSantaCruzLogo.jpg",
        },
      },
      "optionalFile": null,
    },
    {
      ...
      optionalFile: {
        ...
        fileupload: "/SPIE_2019_paper.pdf",
      },
      image: {
        pk: 3,
        name: "IBM Logo",
    ...
    },
    {
      ...
      image: {
        ...
        image: {
          full_size:
            "/imgs/resumeImages/PelhamScoolsLogo.jpg",
        },
      },
    },
  ],
  education: [
    ...
    },
    {
      ...
      image: {
        ...
        image: {
          full_size:
            "/imgs/resumeImages/DobbsFerryHighSchoolLogo.jpg",
        },
      },
    },
  ],
  ...
  awards: [
    {
        ...
        description: "– Testing Quantum Encryption Protocols in Real-life Situations Using Secure Quantum Tunnels",
        date: "2018",
    },
    {
        index: 2,
        title: "International Baccalaureate Award",
        description: "Developed a school-wide program to integrate technology into classrooms",
        date: "2019",
    },
    {
        index: 3,
        title: "Eagle Scout",
        description: "Organized and led service project to build an outdoor classroom at local elementary school to teach students about ecological issues and sustainability",
        date: "2018",
    }
  ],
  publications: [
    {
        index: 1,
        title: "Predicting Conversion to Psychosis in Clinical High Risk Patients using Resting-State Functional MRI Features SPIE. Jolie McDonnell, William Hord, et al.",
  ...
  memberships: [
    {
        index: 1,
        title: "Cruz Hacks",
        description: "Developed an iOS app to detect recyclable materials using machine learning and computer vision",
        date: "January 2020",
    },
    {
        index: 2,
        title: "Slugbotics",
        description: "Facilitating the design, materials sourcing, and fabrication of a 15lb BattleBot for use in the February 2022 Sacramento Battle Bot competition",
        date: "September 2019 - June 2023",
    },
    {
        index: 3,
        title: "Formula Slug",
        description: "Collaborated with team to design components for small electric vehicle using SolidWorks and 3D printing",
